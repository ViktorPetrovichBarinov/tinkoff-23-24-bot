...
import edu.java.responses.scrapper.LinkResponse;
import edu.java.responses.scrapper.ListLinkResponse;
...
public class ScrapperController {
    ...
    @GetMapping("/links")//Аннотация для сопоставления http-get запросов с определённым методом
    ...
    @PostMapping("/links")//Аннотация для сопоставления http-post запросов с определённым методом
    ...
    public ResponseEntity<LinkResponse> deleteLinks(@RequestHeader("Tg-Chat-Id") Long tgChatId,
