...
import edu.java.bot.requests.requestsToScrapper.exceptions.ChatArentExists;
import edu.java.bot.requests.requestsToScrapper.exceptions.IncorrectRequestParameters;
import edu.java.bot.response.scrapper.ApiErrorResponse;
